import {webServerUrl, environment} from './environment';
export const UeditorConfig = {
  serverUrl: webServerUrl,            // 服务器统一请求接口路径

  // 工具栏上的所有的功能按钮和下拉框，可以在new编辑器的实例时选择自己需要的重新定义
  toolbars: [[
    'fullscreen', 'undo', 'redo', '|', 'bold', 'italic', 'underline', 'fontborder', 'strikethrough', 'superscript',
    'subscript', 'removeformat', 'formatmatch', 'autotypeset', 'blockquote', 'pasteplain', '|', 'forecolor', 'backcolor',
    'selectall', 'cleardoc', '|', 'rowspacingtop', 'rowspacingbottom', 'lineheight', '|', 'fontfamily', 'fontsize', '|',
    ...
    'imagecenter', '|', 'insertimage', 'emotion', 'map', '|', 'horizontal', 'date', 'time', 'spechars',
  ...
  initialStyle: 'p,span,pre{line-height:1.4em;}',  // 编辑器层级的基数,可以用来改变字体等
  ...
  //    {tag:'span',name:'span', label:'span', style:'font-style:italic;font-weight:bold'},
...
export const UeditorUploadConfig = {
  ...
  'imageUrlPrefix': environment.otherData.fileServiceUrl, /* 图片访问路径前缀 */
