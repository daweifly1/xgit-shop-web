...
export class ArchivesManageComponent implements OnInit {
  ...
  constructor(private messageService: ShowMessageService, private supplierInfoService: SupplierInfoService,
              ...
              private formBuilder: FormBuilder, private uploadModalService: UploadModalService) {
    this.supplierBasic = {};
   ...
   * 评级导入
   * */
  public doGradeImport() {
    // this.downloadTplUrl = environment.baseUrl.bs + '/supplierFactory/downloadRating';
    // this.importExcel('评级导入', '/supplierFactory/importRating');

    this.importType = ImportFileType.RateInfo;
